...
filename="${PLT_PATH}/actio/dir_gig_f_/gig_f_extst/extst_1/ex1/_deb/res/dir_lg1_/lg1_.sh"
...
dir_fns_="${PLT_PATH}/actio/dir_gig_f_/gig_f_extst/extst_1/ex1/_deb/res"
    #{def_const}
