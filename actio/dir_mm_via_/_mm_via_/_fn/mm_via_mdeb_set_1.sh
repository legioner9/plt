#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/dir_mm_via_/_mm_via_/_fn/mm_via_mdeb_set_1.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_mm_via_/_mm_via_/_fn/mm_via_mdeb_set_1.sh)
