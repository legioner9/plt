#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/dir_upg_env_to_plt_/_upg_env_to_plt_/_fn/upg_env_to_plt_mdeb_set_1.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_upg_env_to_plt_/_upg_env_to_plt_/_fn/upg_env_to_plt_mdeb_set_1.sh)
