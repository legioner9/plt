...
filename="${PLT_PATH}/actio/dir_ttt_/ttt_.sh"
...
# >${FN_OUT_DIR}/com_ttt_.res
# COMMAND &>>${FN_OUT_DIR}/com_ttt_.res
# if [ $? -ne 0 ]; then
#     if [ 1 -eq ${verbose} ]; then
#         cat ${FN_OUT_DIR}/com_ttt_.res
#     fi
#     #? runtime error allowed locally
#     error_allowed_locall_string="STRING"
#     if cat ${FN_OUT_DIR}/COMMAND_ttt_.res | is_rl_siev_and ${error_allowed_locall_string}; then
#         continue
#     else
#         exit_err_ttt_ "runtime error:: COMMAND ${addr}"
#     fi
# fi
#! amount args
