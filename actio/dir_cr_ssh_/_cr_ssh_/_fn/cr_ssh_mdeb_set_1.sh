#!/bin/bash
#. "$HOME/.bashrc"
filename="${PLT_PATH}/actio/dir_cr_ssh_/_cr_ssh_/_fn/cr_ssh_mdeb_set_1.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_cr_ssh_/_cr_ssh_/_fn/cr_ssh_mdeb_set_1.sh)
