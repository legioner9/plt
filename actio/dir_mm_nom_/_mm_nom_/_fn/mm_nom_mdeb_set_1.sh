#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/dir_mm_nom_/_mm_nom_/_fn/mm_nom_mdeb_set_1.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_mm_nom_/_mm_nom_/_fn/mm_nom_mdeb_set_1.sh)
