...
filename=${PLT_PATH}/actio/dir_mm_scr_/mm_scr_extst/extst_1/start_exec.tst
...
#-------------------------------------
#-------------------------------
up_err_ extst ${PLT_PATH}/actio/dir_mm_scr_/mm_scr_extst/extst_1/start_exec.list 1>/dev/null
errno=$?
if [ 1 -eq "${errno}" ]; then
