#!/bin/bash
#. "$HOME/.bashrc"
filename="${PLT_PATH}/actio/dir_mm_apt_/_mm_apt_/_fn/mm_apt_mdeb_set_1.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_mm_apt_/_mm_apt_/_fn/mm_apt_mdeb_set_1.sh)
