#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/dir_mm_cr_repo_plt_/_mm_cr_repo_plt_/_fn/mm_cr_repo_plt_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_mm_cr_repo_plt_/_mm_cr_repo_plt_/_fn/mm_cr_repo_plt_mdeb.sh)
