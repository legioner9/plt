...
MAIN: menu cr fs_plt for any git_repo with git hooks, tst repo - treat repo 
NAME: ${FNN}()
...
${NORMAL}"
    ...
    local ptr_if_
    local ptr_sem_
    unset_autoargs_mm_cr_repo_plt_() {
        echo_=0
        debug_=0
        develop1_=0
        unset errmes_
    ...
    #{see_cntl}
    exit_err_mm_cr_repo_plt_() { #* $1 error message
        local arg1="$1"
        unset_autoargs_mm_cr_repo_plt_
    ...
    # >${FN_OUT_DIR}/com_mm_cr_repo_plt_.res
    # COMMAND &>>${FN_OUT_DIR}/com_mm_cr_repo_plt_.res
    # if [ $? -ne 0 ]; then
    #     if [ 1 -eq ${verbose} ]; then
    #         cat ${FN_OUT_DIR}/com_mm_cr_repo_plt_.res
    #     fi
    #     #? runtime error allowed locally
    #     error_allowed_locall_string="STRING"
    #     if cat ${FN_OUT_DIR}/COMMAND_mm_cr_repo_plt_.res | is_rl_siev_and ${error_allowed_locall_string}; then
    #         continue
    #     else
    #         exit_err_mm_cr_repo_plt_ "runtime error:: COMMAND ${addr}"
    #     fi
    # fi
    #! amount args
    ...
    # ------------------------------------------
    # -----------------------------------------------------------------------------------------
    # altlinux_mm_cr_repo_plt_() {
    #     :
    # }
    # fedora_mm_cr_repo_plt_() {
    #     :
    # }
