...
filename="${PLT_PATH}/actio/dir_cr_sh2_/cr_sh2_.sh"
...
cr_sh2_() {
    ...
    # >${FN_OUT_DIR}/com_cr_sh2_.res
    # COMMAND &>>${FN_OUT_DIR}/com_cr_sh2_.res
    # if [ $? -ne 0 ]; then
    #     if [ 1 -eq ${verbose} ]; then
    #         cat ${FN_OUT_DIR}/com_cr_sh2_.res
    #     fi
    #     #? runtime error allowed locally
    #     error_allowed_locall_string="STRING"
    #     if cat ${FN_OUT_DIR}/COMMAND_cr_sh2_.res | is_rl_siev_and ${error_allowed_locall_string}; then
    #         continue
    #     else
    #         exit_err_cr_sh2_ "runtime error:: COMMAND ${addr}"
    #     fi
    # fi
    #! amount args
