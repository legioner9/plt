...
filename="/home/st/start/communis/Deploy_store/.qa/main_repo_fn/dir_mm_start_/_mm_start_/_fn/cp_issue_to_home_mm_start_.sh"
...
cp_issue_to_home_mm_start_() {
    ...
    wrp_fifs1_ mkdir ${HOME}/soft -cnd1

    wrp_fifs2_ cp -fru /run/media/st/TOSHIBA_EXT/soft/for_copy/. ${HOME}/soft -cd1 -d2
