...
filename="/home/st/start/communis/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/_Head_sis_libs_v.cplus/19_string_h/1_functions/22_strxfrm/cppref_cpjs/exec.sh"
