...
/*#*/ int unseal_cntcharns_lc_str(char *s, int n, char *comment) /* --- */
{
    int i;
    int c;
    printf("%s\n", comment);
...
/*#*/ int uns_ns_lc_str(char *s, int n, char *comment) /* alias unseal_cntcharns_lc_str*/
{
    return unseal_cntcharns_lc_str(s, n, comment);
}
