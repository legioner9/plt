...
filename="/home/st/start/communis/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/_Head_sis_libs_posix/40_sys_socket_h/17_socket/mymind_csdi_un_seq_cpjs/exec.sh"
