...
filename="/home/st/start/communis/Deploy_store/.qa/main_repo_fn/dir_c_/_c_/_man/nbase/_Head_sis_libs_posix/58_wordexp_h/1_wordexp/wordexp_as_ls_cpjs/exec.sh"
