...
filename="$PATH_FN/dir_adf_fn_/adf_fn_.sh"
...
adf_fn_() {
    ...
    *)
        ...
        echo -e "${BLUE}--- cp_h $PATH_FN/dir_f_f_/_f_f_/_tml/_tst $path_tst ---${NORMAL}" #sistem info mesage
        cp_h "$PATH_FN/dir_f_f_/_f_f_/_tml/_tst" "$path_tst"
