#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_ins_nod_/.d.ax/.mdeb/.cntl/ins_nod_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_ins_nod_/.d.ax/.mdeb/.cntl/ins_nod_mdeb.sh)
