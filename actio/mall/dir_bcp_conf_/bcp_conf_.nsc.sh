...
filename="${PLT_PATH}/actio/mall/dir_bcp_conf_/bcp_conf_.nsc.sh"
...
${_plt_exit} " bcp_conf_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_bcp_conf_/.d.ax/.sal.ax/bcp_conf_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/bcp_conf_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_bcp_conf_/.d.ax/.sal.ax/bcp_conf_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_bcp_conf_/.d.ax/.sal.ax/bcp_conf_.body.sh"
return 1
fi
