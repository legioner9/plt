...
filename="${PLT_PATH}/actio/mall/dir_f5go_/f5go_.nsc.sh"
...
${_plt_exit} " f5go_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_f5go_/.d.ax/.sal.ax/f5go_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/f5go_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_f5go_/.d.ax/.sal.ax/f5go_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_f5go_/.d.ax/.sal.ax/f5go_.body.sh"
return 1
fi
