...
filename="${PLT_PATH}/actio/mall/dir_f5arr_/f5arr_.nsc.sh"
...
${_plt_exit} " f5arr_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_f5arr_/.d.ax/.sal.ax/f5arr_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/f5arr_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_f5arr_/.d.ax/.sal.ax/f5arr_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_f5arr_/.d.ax/.sal.ax/f5arr_.body.sh"
return 1
fi
