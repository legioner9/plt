...
filename="${PLT_PATH}/actio/mall/dir_pre_zip_git_/pre_zip_git_.nsc.sh"
...
${_plt_exit} " pre_zip_git_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_pre_zip_git_/.d.ax/.sal.ax/pre_zip_git_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/pre_zip_git_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_pre_zip_git_/.d.ax/.sal.ax/pre_zip_git_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_pre_zip_git_/.d.ax/.sal.ax/pre_zip_git_.body.sh"
return 1
fi
