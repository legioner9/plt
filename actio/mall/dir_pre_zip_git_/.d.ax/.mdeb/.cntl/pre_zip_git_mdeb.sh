#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_pre_zip_git_/.d.ax/.mdeb/.cntl/pre_zip_git_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_pre_zip_git_/.d.ax/.mdeb/.cntl/pre_zip_git_mdeb.sh)
