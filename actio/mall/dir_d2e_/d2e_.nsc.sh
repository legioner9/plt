...
filename="${PLT_PATH}/actio/mall/dir_d2e_/d2e_.nsc.sh"
...
d2e_() {
    ...
    # ${_plt_exit} " d2e_ return 1: ${FNLOCK}"
    # return 1
    # fi
    ...
    for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_d2e_/.d.ax/.sal.ax/d2e_.local.list"); do
    ...
    if ! . "${PLT_PATH}/actio/mall/dir_d2e_/.d.ax/.sal.ax/d2e_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_d2e_/.d.ax/.sal.ax/d2e_.body.sh"
        return 1
    fi
