...
filename="${PLT_PATH}/actio/mall/dir_repo_main_tst_/repo_main_tst_.nsc.sh"
...
if ! . "${PLT_PATH}/actio/mall/dir_repo_main_tst_/.d.ax/.sal.ax/repo_main_tst_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_repo_main_tst_/.d.ax/.sal.ax/repo_main_tst_.body.sh"
return 1
fi
