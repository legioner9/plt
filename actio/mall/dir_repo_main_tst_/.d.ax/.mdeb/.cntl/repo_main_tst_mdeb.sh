#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_repo_main_tst_/.d.ax/.mdeb/.cntl/repo_main_tst_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_repo_main_tst_/.d.ax/.mdeb/.cntl/repo_main_tst_mdeb.sh)
