...
filename="${PLT_PATH}/actio/mall/dir_bcp_sys_/bcp_sys_.nsc.sh"
...
${_plt_exit} " bcp_sys_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_bcp_sys_/.d.ax/.sal.ax/bcp_sys_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/bcp_sys_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_bcp_sys_/.d.ax/.sal.ax/bcp_sys_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_bcp_sys_/.d.ax/.sal.ax/bcp_sys_.body.sh"
return 1
fi
