#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_bcp_sys_/.d.ax/.mdeb/a2_fp_f_mdeb_first.sh"
...
a2_fp_f_mdeb_first() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_bcp_sys_/.d.ax/.mdeb/a2_fp_f_mdeb_first.sh)
