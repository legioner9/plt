#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_bcp_sys_/.d.ax/.mdeb/.cntl/bcp_sys_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_bcp_sys_/.d.ax/.mdeb/.cntl/bcp_sys_mdeb.sh)
