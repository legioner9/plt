#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_f3e_/.d.ax/.mdeb/a_tst_1_fp_f_mdeb_7.sh"
...
a_tst_1_fp_f_mdeb_7() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_f3e_/.d.ax/.mdeb/a_tst_1_fp_f_mdeb_7.sh)
...
${NORMAL}"
    ...
    f3e_ /home/st/REPOBARE/_repo/plt/actio/mall/dir_f3e_/.d.ax/.mdeb/.tmp/0
    #{body_fn}
}
