...
filename="${PLT_PATH}/actio/mall/dir_mm_exec_dir_/mm_exec_dir_.nsc.sh"
...
${_plt_exit} " mm_exec_dir_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_mm_exec_dir_/.d.ax/.sal.ax/mm_exec_dir_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/mm_exec_dir_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_mm_exec_dir_/.d.ax/.sal.ax/mm_exec_dir_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_mm_exec_dir_/.d.ax/.sal.ax/mm_exec_dir_.body.sh"
return 1
fi
