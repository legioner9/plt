#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_mm_exec_dir_/.d.ax/.mdeb/.cntl/mm_exec_dir_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_mm_exec_dir_/.d.ax/.mdeb/.cntl/mm_exec_dir_mdeb.sh)
