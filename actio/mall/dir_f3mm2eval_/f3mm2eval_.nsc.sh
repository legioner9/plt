...
filename="${PLT_PATH}/actio/mall/dir_f3mm2eval_/f3mm2eval_.nsc.sh"
...
${_plt_exit} " f3mm2eval_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_f3mm2eval_/.d.ax/.sal.ax/f3mm2eval_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/f3mm2eval_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_f3mm2eval_/.d.ax/.sal.ax/f3mm2eval_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_f3mm2eval_/.d.ax/.sal.ax/f3mm2eval_.body.sh"
return 1
fi
