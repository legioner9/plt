#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_dr2e_v2_/.d.ax/.mdeb/a002_fp_f_mdeb_init.sh"
...
a002_fp_f_mdeb_init() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_dr2e_v2_/.d.ax/.mdeb/a002_fp_f_mdeb_init.sh)
...
${NORMAL}"
    ...
    #{default_cntl_fn}
    # amount_arg $# 1 1
        cd ${PLT_PATH}/actio/mall/dir_dr2e_v2_/.d.ax/.mdeb/.tmp || {
        plt_exit "in ${FNN} : NOT_DIR : '${PLT_PATH}/actio/mall/dir_dr2e_v2_/.d.ax/.mdeb/.tmp' return 1"
        return 1
    }
