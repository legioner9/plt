...
filename="${PLT_PATH}/actio/mall/dir_dr2e_v2_/dr2e_v2_.nsc.sh"
...
dr2e_v2_() {
    ...
    #     ${_plt_exit} " dr2e_v2_ return 1: ${FNLOCK}"
    #     return 1
    # fi
    ...
    for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_dr2e_v2_/.d.ax/.sal.ax/dr2e_v2_.local.list"); do
    ...
    if ! . "${PLT_PATH}/actio/mall/dir_dr2e_v2_/.d.ax/.sal.ax/dr2e_v2_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_dr2e_v2_/.d.ax/.sal.ax/dr2e_v2_.body.sh"
        return 1
    fi
