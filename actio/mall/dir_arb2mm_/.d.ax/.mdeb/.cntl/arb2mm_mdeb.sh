#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_arb2mm_/.d.ax/.mdeb/.cntl/arb2mm_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_arb2mm_/.d.ax/.mdeb/.cntl/arb2mm_mdeb.sh)
