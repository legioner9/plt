#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a07_fp_f_mdeb_delram.sh"
...
a07_fp_f_mdeb_delram() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a07_fp_f_mdeb_delram.sh)
