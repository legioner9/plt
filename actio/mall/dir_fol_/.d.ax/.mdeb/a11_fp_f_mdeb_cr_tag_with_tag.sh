#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a11_fp_f_mdeb_cr_tag_with_tag.sh"
...
a11_fp_f_mdeb_cr_tag_with_tag() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a11_fp_f_mdeb_cr_tag_with_tag.sh)
...
${NORMAL}"
    ...
    plt_pause "fol_ --_tag @new_tag -_crtag , -_deltag  "
