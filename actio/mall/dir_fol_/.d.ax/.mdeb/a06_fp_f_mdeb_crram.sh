#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a06_fp_f_mdeb_crram.sh"
...
a06_fp_f_mdeb_crram() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a06_fp_f_mdeb_crram.sh)
