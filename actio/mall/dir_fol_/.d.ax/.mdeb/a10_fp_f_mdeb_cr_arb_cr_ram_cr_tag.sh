#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a10_fp_f_mdeb_cr_arb_cr_ram_cr_tag.sh"
...
a10_fp_f_mdeb_cr_arb_cr_ram_cr_tag() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a10_fp_f_mdeb_cr_arb_cr_ram_cr_tag.sh)
