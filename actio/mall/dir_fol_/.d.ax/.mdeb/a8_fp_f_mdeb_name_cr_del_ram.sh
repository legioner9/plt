#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a8_fp_f_mdeb_name_cr_del_ram.sh"
...
a8_fp_f_mdeb_name_cr_del_ram() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a8_fp_f_mdeb_name_cr_del_ram.sh)
