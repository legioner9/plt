#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a14_fp_f_mdeb_utag.sh"
...
a14_fp_f_mdeb_utag() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a14_fp_f_mdeb_utag.sh)
