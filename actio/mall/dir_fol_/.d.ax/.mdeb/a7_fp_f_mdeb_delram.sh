#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a7_fp_f_mdeb_delram.sh"
...
a7_fp_f_mdeb_delram() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a7_fp_f_mdeb_delram.sh)
