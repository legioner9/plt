#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a18_fp_f_mdeb_edit_ram.sh"
...
a18_fp_f_mdeb_edit_ram() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a18_fp_f_mdeb_edit_ram.sh)
