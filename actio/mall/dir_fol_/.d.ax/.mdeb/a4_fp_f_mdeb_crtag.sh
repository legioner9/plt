#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a4_fp_f_mdeb_crtag.sh"
...
a4_fp_f_mdeb_crtag() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a4_fp_f_mdeb_crtag.sh)
