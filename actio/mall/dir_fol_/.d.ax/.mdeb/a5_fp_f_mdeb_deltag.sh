#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a5_fp_f_mdeb_deltag.sh"
...
a5_fp_f_mdeb_deltag() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a5_fp_f_mdeb_deltag.sh)
...
${NORMAL}"
    ...
    plt_pause "fol_ -_mm -_deltag flow "
