#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a13_fp_f_mdeb_gig_fs_infns.sh"
...
a13_fp_f_mdeb_gig_fs_infns() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a13_fp_f_mdeb_gig_fs_infns.sh)
...
${NORMAL}"
    ...
    # cd ${fol_dir}/06_ram_flow || plt_exit "NOT_DIR : ${fol_dir}/06_ram_flow"
    # cr_infn_ --_fn "01_cr_ram" --_root_dir "${root_dir}"
    # cr_infn_ --_fn "02_del_ram" --_root_dir "${root_dir}"

    # mkdir -v ${fol_dir}/07_tag_flow
    # cd ${fol_dir}/07_tag_flow || plt_exit "NOT_DIR : ${fol_dir}/07_tag_flow"
    # cr_infn_ --_fn "01_cr_tag" --_root_dir "${root_dir}"
