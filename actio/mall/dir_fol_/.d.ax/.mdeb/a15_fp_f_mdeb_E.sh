#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a15_fp_f_mdeb_E.sh"
...
a15_fp_f_mdeb_E() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_fol_/.d.ax/.mdeb/a15_fp_f_mdeb_E.sh)
