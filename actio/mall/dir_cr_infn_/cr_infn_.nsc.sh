...
filename="${PLT_PATH}/actio/mall/dir_cr_infn_/cr_infn_.nsc.sh"
...
${_plt_exit} " cr_infn_ return 1: ${FNLOCK}"
return 1
fi
...
for var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_cr_infn_/.d.ax/.sal.ax/cr_infn_.local.list"); do
...
if ! . "${PLT_PATH}/actio/mall/dir_cr_infn_/.d.ax/.sal.ax/cr_infn_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_cr_infn_/.d.ax/.sal.ax/cr_infn_.body.sh"
return 1
fi
