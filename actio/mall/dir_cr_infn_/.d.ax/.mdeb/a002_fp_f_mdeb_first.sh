#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_cr_infn_/.d.ax/.mdeb/a002_fp_f_mdeb_first.sh"
...
a002_fp_f_mdeb_first() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_cr_infn_/.d.ax/.mdeb/a002_fp_f_mdeb_first.sh)
...
${NORMAL}"
    ...
    # amount_arg $# 1 1
    #{body_fn}
    plt_pause "DO? cr_infn_ --_fn "01_ttm_fn" --_par_dir_ "02_pd" --_par_fn fool_"

    cd "${PLT_PATH}"/actio/mall/dir_cr_infn_/.d.ax/.mdeb/.tmp/_deb ||
