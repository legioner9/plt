#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_nm_opi_/.d.ax/.mdeb/a005_fp_f_mdeb_add_files.sh"
...
a005_fp_f_mdeb_add_files() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_nm_opi_/.d.ax/.mdeb/a005_fp_f_mdeb_add_files.sh)
