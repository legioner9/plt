#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_nm_opi_/.d.ax/.mdeb/a006_fp_f_mdeb_lower.sh"
...
a006_fp_f_mdeb_lower() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_nm_opi_/.d.ax/.mdeb/a006_fp_f_mdeb_lower.sh)
...
${NORMAL}"
    ...
    rm -rf ${REPO_PATH}/tgu
    echo -e "${HLIGHT}--- rm -rf ${REPO_PATH}/NNet ---${NORMAL}" #start files
    rm -rf ${REPO_PATH}/NNet
