#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_nm_opi_/.d.ax/.mdeb/a004_fp_f_mdeb_push.sh"
...
a004_fp_f_mdeb_push() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_nm_opi_/.d.ax/.mdeb/a004_fp_f_mdeb_push.sh)
