#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_nm_opi_/.d.ax/.mdeb/a003_fp_f_mdeb_pull.sh"
...
a003_fp_f_mdeb_pull() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_nm_opi_/.d.ax/.mdeb/a003_fp_f_mdeb_pull.sh)
