...
filename="${PLT_PATH}/actio/mall/dir_edit_/edit_.nsc.sh"
...
${_plt_exit} " edit_ return 1: ${FNLOCK}"
return 1
fi
...
for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_edit_/.d.ax/.sal.ax/edit_.local.list"); do
...
if ! . "${PLT_PATH}/actio/mall/dir_edit_/.d.ax/.sal.ax/edit_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_edit_/.d.ax/.sal.ax/edit_.body.sh"
return 1
fi
