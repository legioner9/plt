#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_gig_f_/.d.ax/.mdeb/a2_fp_f_mdeb_min_start.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_gig_f_/.d.ax/.mdeb/a2_fp_f_mdeb_min_start.sh)
