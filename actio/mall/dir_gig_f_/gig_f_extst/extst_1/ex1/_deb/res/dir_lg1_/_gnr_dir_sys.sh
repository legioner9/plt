...
filename="${PLT_PATH}/actio/mall/dir_gig_f_/gig_f_extst/extst_1/ex1/_deb/res/dir_lg1_/_gnr_dir_sys.sh"
...
#
${_ehh_} rm ${rdir}/${gname}.tmp.exl
#
echo -e "
${_ehh_} cd ${rdir}
#
${_ehh_} mkdir ${rdir}/"$1"_extst
#
${_ehh_} cd ${rdir}/"$1"_extst
#
