...
${_gig_f_} --_name_fn lg1_ --_dir_fns ${PLT_PATH}/actio/mall/dir_gig_f_/gig_f_extst/extst_1/ex1/_deb/res --_grad mall --_tail prov -_cr > ${PLT_PATH}/actio/mall/dir_gig_f_/gig_f_extst/extst_1/ex1/log
