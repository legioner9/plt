...
filename="${PLT_PATH}/actio/mall/dir_tag2f_/tag2f_.nsc.sh"
...
tag2f_() {
    ...
    #     ${_plt_exit} " tag2f_ return 1: ${FNLOCK}"
    #     return 1
    # fi
    ...
    #     eval local $strex
    # done
    for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_tag2f_/.d.ax/.sal.ax/tag2f_.local.list"); do
    ...
    # echo ". ${FN_SAL_DIR}/tag2f_.body.nsc.sh"
    if ! . "${PLT_PATH}/actio/mall/dir_tag2f_/.d.ax/.sal.ax/tag2f_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_tag2f_/.d.ax/.sal.ax/tag2f_.body.sh"
        return 1
    fi
