...
filename="${PLT_PATH}/actio/mall/dir_f3arrparr_/f3arrparr_.nsc.sh"
...
${_plt_exit} " f3arrparr_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_f3arrparr_/.d.ax/.sal.ax/f3arrparr_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/f3arrparr_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_f3arrparr_/.d.ax/.sal.ax/f3arrparr_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_f3arrparr_/.d.ax/.sal.ax/f3arrparr_.body.sh"
return 1
fi
