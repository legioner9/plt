...
filename="${PLT_PATH}/actio/mall/dir_dre2parr_/dre2parr_.nsc.sh"
...
dre2parr_() {
    ...
    #     ${_plt_exit} " dre2parr_ return 1: ${FNLOCK}"
    #     return 1
    # fi
    ...
    for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_dre2parr_/.d.ax/.sal.ax/dre2parr_.local.list"); do
    ...
    if ! . "${PLT_PATH}/actio/mall/dir_dre2parr_/.d.ax/.sal.ax/dre2parr_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_dre2parr_/.d.ax/.sal.ax/dre2parr_.body.sh"
        return 1
    fi
