...
filename="${PLT_PATH}/actio/mall/dir_l2exec_/l2exec_.nsc.sh"
...
l2exec_() {
    ...
    #     ${_plt_exit} " l2exec_ return 1: ${FNLOCK}"
    #     return 1
    # fi
    ...
    for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_l2exec_/.d.ax/.sal.ax/l2exec_.local.list"); do
    ...
    # echo ". ${FN_SAL_DIR}/l2exec_.body.nsc.sh"
    if ! . "${PLT_PATH}/actio/mall/dir_l2exec_/.d.ax/.sal.ax/l2exec_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_l2exec_/.d.ax/.sal.ax/l2exec_.body.sh"
        return 1
    fi
