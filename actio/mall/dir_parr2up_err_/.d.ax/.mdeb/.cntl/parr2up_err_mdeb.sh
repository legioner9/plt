#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_parr2up_err_/.d.ax/.mdeb/.cntl/parr2up_err_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_parr2up_err_/.d.ax/.mdeb/.cntl/parr2up_err_mdeb.sh)
