#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_parr2up_err_/.d.ax/.mdeb/a001_fp_f_mdeb_zx.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_parr2up_err_/.d.ax/.mdeb/a001_fp_f_mdeb_zx.sh)
