...
filename="${PLT_PATH}/actio/mall/dir_nmw_opi_/nmw_opi_.nsc.sh"
...
nmw_opi_() {
    ...
    # ${_plt_exit} " nmw_opi_ return 1: ${FNLOCK}"
    # return 1
    # fi
    ...
    for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_nmw_opi_/.d.ax/.sal.ax/nmw_opi_.local.list"); do
    ...
    if ! . "${PLT_PATH}/actio/mall/dir_nmw_opi_/.d.ax/.sal.ax/nmw_opi_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_nmw_opi_/.d.ax/.sal.ax/nmw_opi_.body.sh"
        return 1
    fi
