#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_nmw_opi_/.d.ax/.mdeb/.cntl/nmw_opi_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_nmw_opi_/.d.ax/.mdeb/.cntl/nmw_opi_mdeb.sh)
