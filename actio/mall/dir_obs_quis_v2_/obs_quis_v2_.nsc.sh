...
filename="${PLT_PATH}/actio/mall/dir_obs_quis_v2_/obs_quis_v2_.sh"
...
# echo ". ${FN_SAL_DIR}/obs_quis_v2_.body.nsc.sh"
if ! . "${FN_SAL_DIR}/obs_quis_v2_.body.nsc.sh"; then
${_plt_exit} "fail: . ${FN_SAL_DIR}/obs_quis_v2_.body.sh"
return 1
fi
