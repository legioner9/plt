...
filename="${PLT_PATH}/actio/mall/dir_nit_/nit_.nsc.sh"
...
nit_() {
    ...
    if ! . "${PLT_PATH}/actio/mall/dir_nit_/.d.ax/.sal.ax/nit_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_nit_/.d.ax/.sal.ax/nit_.body.sh"
        return 1
    fi
