...
filename="${PLT_PATH}/actio/mall/dir_ram2arb_/ram2arb_.nsc.sh"
...
${_plt_exit} " ram2arb_ return 1: ${FNLOCK}"
return 1
fi
...
for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_ram2arb_/.d.ax/.sal.ax/ram2arb_.local.list"); do
...
if ! . "${PLT_PATH}/actio/mall/dir_ram2arb_/.d.ax/.sal.ax/ram2arb_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_ram2arb_/.d.ax/.sal.ax/ram2arb_.body.sh"
return 1
fi
