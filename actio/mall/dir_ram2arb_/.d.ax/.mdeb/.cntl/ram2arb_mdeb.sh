#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_ram2arb_/.d.ax/.mdeb/.cntl/ram2arb_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_ram2arb_/.d.ax/.mdeb/.cntl/ram2arb_mdeb.sh)
