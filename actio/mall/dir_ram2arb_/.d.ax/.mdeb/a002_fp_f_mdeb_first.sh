#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_ram2arb_/.d.ax/.mdeb/a002_fp_f_mdeb_first.sh"
...
a002_fp_f_mdeb_first() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_ram2arb_/.d.ax/.mdeb/a002_fp_f_mdeb_first.sh)
