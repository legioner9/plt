#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_bcp_strc_/.d.ax/.mdeb/.cntl/bcp_strc_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_bcp_strc_/.d.ax/.mdeb/.cntl/bcp_strc_mdeb.sh)
