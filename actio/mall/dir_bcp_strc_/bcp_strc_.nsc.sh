...
filename="${PLT_PATH}/actio/mall/dir_bcp_strc_/bcp_strc_.nsc.sh"
...
${_plt_exit} " bcp_strc_ return 1: ${FNLOCK}"
return 1
fi
...
for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_bcp_strc_/.d.ax/.sal.ax/bcp_strc_.local.list"); do
...
if ! . "${PLT_PATH}/actio/mall/dir_bcp_strc_/.d.ax/.sal.ax/bcp_strc_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_bcp_strc_/.d.ax/.sal.ax/bcp_strc_.body.sh"
return 1
fi
