#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_s3parr_/.d.ax/.mdeb/a3_fp_f_mdeb_s3parr.sh"
...
a3_fp_f_mdeb_s3parr() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_s3parr_/.d.ax/.mdeb/a3_fp_f_mdeb_s3parr.sh)
...
${NORMAL}"
    ...
    s3parr_ --_str "ewrved:erfwe:cgbb" --_parr p_arr --_del :
