...
filename="${PLT_PATH}/actio/mall/dir_s3parr_/s3parr_.nsc.sh"
...
${_plt_exit} " s3parr_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_s3parr_/.d.ax/.sal.ax/s3parr_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/s3parr_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_s3parr_/.d.ax/.sal.ax/s3parr_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_s3parr_/.d.ax/.sal.ax/s3parr_.body.sh"
return 1
fi
