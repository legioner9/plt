...
filename="${PLT_PATH}/actio/mall/dir_fs_/fs_.nsc.sh"
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_fs_/.d.ax/.sal.ax/fs_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/fs_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_fs_/.d.ax/.sal.ax/fs_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_fs_/.d.ax/.sal.ax/fs_.body.sh"
return 1
fi
