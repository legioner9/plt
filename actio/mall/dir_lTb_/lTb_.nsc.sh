...
filename="${PLT_PATH}/actio/mall/dir_lTb_/lTb_.nsc.sh"
...
${_plt_exit} " lTb_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_lTb_/.d.ax/.sal.ax/lTb_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/lTb_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_lTb_/.d.ax/.sal.ax/lTb_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_lTb_/.d.ax/.sal.ax/lTb_.body.sh"
return 1
fi
