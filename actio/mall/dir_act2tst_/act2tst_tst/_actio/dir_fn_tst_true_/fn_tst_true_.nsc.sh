...
filename="${PLT_PATH}/actio/mall/dir_act2tst_/act2tst_tst/_actio/dir_fn_tst_true_/fn_tst_true_.nsc.sh"
...
${_plt_exit} " fn_tst_true_ return 1: ${FNLOCK}"
return 1
fi
...
for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_fn_tst_true_/.d.ax/.sal.ax/fn_tst_true_.local.list"); do
...
if ! . "${PLT_PATH}/actio/mall/dir_act2tst_/act2tst_tst/_actio/dir_fn_tst_true_/.d.ax/.sal.ax/fn_tst_true_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_act2tst_/act2tst_tst/_actio/dir_fn_tst_true_/.d.ax/.sal.ax/fn_tst_true_.body.sh"
return 1
fi
