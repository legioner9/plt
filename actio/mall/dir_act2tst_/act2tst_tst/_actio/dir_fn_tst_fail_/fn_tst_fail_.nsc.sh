...
filename="${PLT_PATH}/actio/mall/dir_act2tst_/act2tst_tst/_actio/dir_fn_tst_fail_/fn_tst_fail_.nsc.sh"
...
local dir_fns_="${PLT_PATH}/actio/mall/dir_act2tst_/act2tst_tst/_actio"
    #{def_const}
...
${_plt_exit} " fn_tst_fail_ return 1: ${FNLOCK}"
return 1
fi
...
for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_fn_tst_fail_/.d.ax/.sal.ax/fn_tst_fail_.local.list"); do
...
if ! . "${PLT_PATH}/actio/mall/dir_act2tst_/act2tst_tst/_actio/dir_fn_tst_fail_/.d.ax/.sal.ax/fn_tst_fail_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_act2tst_/act2tst_tst/_actio/dir_fn_tst_fail_/.d.ax/.sal.ax/fn_tst_fail_.body.sh"
return 1
fi
