#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_act2tst_/.d.ax/.mdeb/.cntl/act2tst_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_act2tst_/.d.ax/.mdeb/.cntl/act2tst_mdeb.sh)
