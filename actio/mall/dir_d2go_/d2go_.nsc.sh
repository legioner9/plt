...
filename="${PLT_PATH}/actio/mall/dir_d2go_/d2go_.nsc.sh"
...
${_plt_exit} " d2go_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_d2go_/.d.ax/.sal.ax/d2go_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/d2go_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_d2go_/.d.ax/.sal.ax/d2go_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_d2go_/.d.ax/.sal.ax/d2go_.body.sh"
return 1
fi
