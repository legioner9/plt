#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_el_f_prp_/.d.ax/.mdeb/.cntl/el_f_prp_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_el_f_prp_/.d.ax/.mdeb/.cntl/el_f_prp_mdeb.sh)
