#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_uEfn_/.d.ax/.mdeb/a2_fp_f_mdeb_do_1.sh"
...
a2_fp_f_mdeb_do_1() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_uEfn_/.d.ax/.mdeb/a2_fp_f_mdeb_do_1.sh)
