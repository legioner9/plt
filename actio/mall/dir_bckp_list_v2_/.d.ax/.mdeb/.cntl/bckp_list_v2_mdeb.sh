#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_bckp_list_v2_/.d.ax/.mdeb/.cntl/bckp_list_v2_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_bckp_list_v2_/.d.ax/.mdeb/.cntl/bckp_list_v2_mdeb.sh)
