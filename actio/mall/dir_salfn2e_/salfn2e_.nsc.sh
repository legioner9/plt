...
filename="${PLT_PATH}/actio/mall/dir_salfn2e_/salfn2e_.nsc.sh"
...
${_plt_exit} " salfn2e_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_salfn2e_/.d.ax/.sal.ax/salfn2e_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/salfn2e_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_salfn2e_/.d.ax/.sal.ax/salfn2e_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_salfn2e_/.d.ax/.sal.ax/salfn2e_.body.sh"
return 1
fi
