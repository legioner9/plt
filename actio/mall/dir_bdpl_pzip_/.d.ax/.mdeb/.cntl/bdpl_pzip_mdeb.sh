#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_bdpl_pzip_/.d.ax/.mdeb/.cntl/bdpl_pzip_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_bdpl_pzip_/.d.ax/.mdeb/.cntl/bdpl_pzip_mdeb.sh)
