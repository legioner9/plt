#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_bdpl_pzip_/.d.ax/.mdeb/a002_fp_f_mdeb_init.sh"
...
a002_fp_f_mdeb_init() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_bdpl_pzip_/.d.ax/.mdeb/a002_fp_f_mdeb_init.sh)
