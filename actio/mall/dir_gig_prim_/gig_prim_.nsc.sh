...
filename="${PLT_PATH}/actio/mall/dir_gig_prim_/gig_prim_.sh"
...
# echo ". ${FN_SAL_DIR}/gig_prim_.body.nsc.sh"
if ! . "${FN_SAL_DIR}/gig_prim_.body.nsc.sh"; then
${_plt_exit} "fail: . ${FN_SAL_DIR}/gig_prim_.body.sh"
return 1
fi
