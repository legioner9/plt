...
filename="${PLT_PATH}/actio/mall/dir_gig_mall_/gig_mall_.sh"
...
# echo ". ${FN_SAL_DIR}/gig_mall_.body.nsc.sh"
if ! . "${FN_SAL_DIR}/gig_mall_.body.nsc.sh"; then
${_plt_exit} "fail: . ${FN_SAL_DIR}/gig_mall_.body.sh"
return 1
fi
