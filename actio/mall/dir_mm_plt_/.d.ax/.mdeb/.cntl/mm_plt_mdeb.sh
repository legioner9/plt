#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_mm_plt_/.d.ax/.mdeb/.cntl/mm_plt_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_mm_plt_/.d.ax/.mdeb/.cntl/mm_plt_mdeb.sh)
