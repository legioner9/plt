#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_mm_plt_/.d.ax/.mm_plt_/_fn/mm_plt_all_actio_.sh"
...
mm_plt_all_actio_() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_mm_plt_/.d.ax/.mm_plt_/_fn/mm_plt_all_actio_.sh)
