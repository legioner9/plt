#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_mm_plt_/.d.ax/.mm_plt_/_fn/mm_plt_all_actio_main_.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_mm_plt_/.d.ax/.mm_plt_/_fn/mm_plt_all_actio_main_.sh)
