...
filename="${PLT_PATH}/actio/mall/dir__ttt/_ttt.nsc.sh"
...
${_plt_exit} " _ttt return 1: ${FNLOCK}"
return 1
fi
...
for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir__ttt/.d.ax/.sal.ax/_ttt.local.list"); do
...
if ! . "${PLT_PATH}/actio/mall/dir__ttt/.d.ax/.sal.ax/_ttt.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir__ttt/.d.ax/.sal.ax/_ttt.body.sh"
return 1
fi
