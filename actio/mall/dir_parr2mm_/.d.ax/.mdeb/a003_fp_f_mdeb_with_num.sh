#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_parr2mm_/.d.ax/.mdeb/a003_fp_f_mdeb_with_num.sh"
...
a003_fp_f_mdeb_with_num() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_parr2mm_/.d.ax/.mdeb/a003_fp_f_mdeb_with_num.sh)
