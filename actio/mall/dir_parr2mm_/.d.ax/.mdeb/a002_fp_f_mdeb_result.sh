#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_parr2mm_/.d.ax/.mdeb/a002_fp_f_mdeb_result.sh"
...
a002_fp_f_mdeb_result() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_parr2mm_/.d.ax/.mdeb/a002_fp_f_mdeb_result.sh)
