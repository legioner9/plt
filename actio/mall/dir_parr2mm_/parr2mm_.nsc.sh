...
filename="${PLT_PATH}/actio/mall/dir_parr2mm_/parr2mm_.nsc.sh"
...
parr2mm_() {
    ...
    #     ${_plt_exit} " parr2mm_ return 1: ${FNLOCK}"
    #     return 1
    # fi
    ...
    for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_parr2mm_/.d.ax/.sal.ax/parr2mm_.local.list"); do
    ...
    if ! . "${PLT_PATH}/actio/mall/dir_parr2mm_/.d.ax/.sal.ax/parr2mm_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_parr2mm_/.d.ax/.sal.ax/parr2mm_.body.sh"
        return 1
    fi
