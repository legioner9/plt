#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_arb2f_/.d.ax/.mdeb/a002_fp_f_mdeb_check.sh"
...
a002_fp_f_mdeb_check() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_arb2f_/.d.ax/.mdeb/a002_fp_f_mdeb_check.sh)
