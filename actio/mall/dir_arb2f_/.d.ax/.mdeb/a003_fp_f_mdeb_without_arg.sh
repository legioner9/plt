#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_arb2f_/.d.ax/.mdeb/a003_fp_f_mdeb_without_arg.sh"
...
a003_fp_f_mdeb_without_arg() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_arb2f_/.d.ax/.mdeb/a003_fp_f_mdeb_without_arg.sh)
