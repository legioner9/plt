...
filename="${PLT_PATH}/actio/mall/dir_gig_mall_v2_/gig_mall_v2_.nsc.sh"
...
gig_mall_v2_() {
    ...
    if ! ${_garg2e2_} "${ARGS[@]}"; then
        ${_plt_exit} " gig_mall_v2_ return 1: ${FNLOCK}"
        return 1
    fi
    ...
    for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_gig_mall_v2_/.d.ax/.sal.ax/gig_mall_v2_.local.list"); do
    ...
    # echo ". ${FN_SAL_DIR}/gig_mall_v2_.body.nsc.sh"
    if ! . "${PLT_PATH}/actio/mall/dir_gig_mall_v2_/.d.ax/.sal.ax/gig_mall_v2_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_gig_mall_v2_/.d.ax/.sal.ax/gig_mall_v2_.body.sh"
        return 1
    fi
