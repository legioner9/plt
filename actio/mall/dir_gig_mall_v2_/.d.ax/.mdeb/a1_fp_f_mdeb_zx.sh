#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_gig_mall_v2_/.d.ax/.mdeb/a1_fp_f_mdeb_zx.sh"
...
a1_fp_f_mdeb_zx() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_gig_mall_v2_/.d.ax/.mdeb/a1_fp_f_mdeb_zx.sh)
