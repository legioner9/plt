#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_gig_mall_v2_/.d.ax/.mdeb/a4_fp_f_mdeb_cr_like_tmp.sh"
...
a4_fp_f_mdeb_cr_like_tmp() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_gig_mall_v2_/.d.ax/.mdeb/a4_fp_f_mdeb_cr_like_tmp.sh)
...
${NORMAL}"
    ...
    #{default_cntl_fn}
    # amount_arg $# 1 1
    res_actio=${PLT_PATH}/actio/mall/dir__tmp2_
    res_sal=${PLT_PATH}/.d/.sal.ax/_tmp2_
