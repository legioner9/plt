#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_gig_mall_v2_/.d.ax/.mdeb/.cntl/gig_mall_v2_mdeb.sh"
...
gig_mall_v2_mdeb() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_gig_mall_v2_/.d.ax/.mdeb/.cntl/gig_mall_v2_mdeb.sh)
