#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_pzip_to_/.d.ax/.mdeb/a002_fp_f_mdeb_stream.sh"
...
a002_fp_f_mdeb_stream() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_pzip_to_/.d.ax/.mdeb/a002_fp_f_mdeb_stream.sh)
