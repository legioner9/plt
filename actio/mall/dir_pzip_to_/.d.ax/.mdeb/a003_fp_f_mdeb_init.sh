#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_pzip_to_/.d.ax/.mdeb/a003_fp_f_mdeb_init.sh"
...
a003_fp_f_mdeb_init() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_pzip_to_/.d.ax/.mdeb/a003_fp_f_mdeb_init.sh)
...
${NORMAL}"
    ...
    # done
    #{default_cntl_fn}
    local dir_003="/home/st/REPOBARE/_repo/plt/actio/mall/dir_pzip_to_/.d.ax/.mdeb/.tmp/003"
