#!/usr/bin/env bash
filename=${PLT_PATH}/actio/mall/dir_pzip_to_/pzip_to_extst/extst_1/ex2/_flow_tst.sh
...
plt_info "START flow pzip_to_ \${PD_READ} \${dist} \${src} 1 - with selfcheck"

: >res

dir_003="${PLT_PATH}/actio/mall/dir_pzip_to_/pzip_to_extst/extst_1/ex2/003"
...
# rm -v ${dist}dir_003="${PLT_PATH}/actio/mall/dir_pzip_to_/pzip_to_extst/extst_1/ex1/003"
