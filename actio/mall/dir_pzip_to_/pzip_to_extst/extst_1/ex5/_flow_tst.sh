#!/usr/bin/env bash
filename=${PLT_PATH}/actio/mall/dir_pzip_to_/pzip_to_extst/extst_1/ex5/_flow_tst.sh
...
plt_info "START flow pzip_to_ 0 \${dist} \${src} 1"

: >res

dir_003="${PLT_PATH}/actio/mall/dir_pzip_to_/pzip_to_extst/extst_1/ex5/dir_4"
...
echo -e "${HLIGHT}--- pzip_to_ 0 file://${dist} file://${src} 1 ---${NORMAL}" #start files
pzip_to_ 0 "${dist}" "${src}" 1
