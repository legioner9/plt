...
filename="${PLT_PATH}/actio/mall/dir_pzip_to_/pzip_to_.nsc.sh"
...
${_plt_exit} " pzip_to_ return 1: ${FNLOCK}"
return 1
fi
...
for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_pzip_to_/.d.ax/.sal.ax/pzip_to_.local.list"); do
...
if ! . "${PLT_PATH}/actio/mall/dir_pzip_to_/.d.ax/.sal.ax/pzip_to_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_pzip_to_/.d.ax/.sal.ax/pzip_to_.body.sh"
return 1
fi
