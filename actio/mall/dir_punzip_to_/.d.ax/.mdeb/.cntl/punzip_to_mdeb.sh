#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_punzip_to_/.d.ax/.mdeb/.cntl/punzip_to_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_punzip_to_/.d.ax/.mdeb/.cntl/punzip_to_mdeb.sh)
