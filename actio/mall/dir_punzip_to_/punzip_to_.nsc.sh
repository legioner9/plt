...
filename="${PLT_PATH}/actio/mall/dir_punzip_to_/punzip_to_.nsc.sh"
...
punzip_to_() {
    ...
    #     ${_plt_exit} " punzip_to_ return 1: ${FNLOCK}"
    #     return 1
    # fi
    ...
    for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_punzip_to_/.d.ax/.sal.ax/punzip_to_.local.list"); do
    ...
    if ! . "${PLT_PATH}/actio/mall/dir_punzip_to_/.d.ax/.sal.ax/punzip_to_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_punzip_to_/.d.ax/.sal.ax/punzip_to_.body.sh"
        return 1
    fi
