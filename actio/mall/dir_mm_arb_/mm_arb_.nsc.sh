...
filename="${PLT_PATH}/actio/mall/dir_mm_arb_/mm_arb_.nsc.sh"
...
${_plt_exit} " mm_arb_ return 1: ${FNLOCK}"
return 1
fi
...
for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_mm_arb_/.d.ax/.sal.ax/mm_arb_.local.list"); do
...
if ! . "${PLT_PATH}/actio/mall/dir_mm_arb_/.d.ax/.sal.ax/mm_arb_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_mm_arb_/.d.ax/.sal.ax/mm_arb_.body.sh"
return 1
fi
