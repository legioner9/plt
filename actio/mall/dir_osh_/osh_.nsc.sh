...
filename="${PLT_PATH}/actio/mall/dir_osh_/osh_.nsc.sh"
...
osh_() {
    ...
    #     ${_plt_exit} " osh_ return 1: ${FNLOCK}"
    #     return 1
    # fi
    ...
    for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_osh_/.d.ax/.sal.ax/osh_.local.list"); do
    ...
    if ! . "${PLT_PATH}/actio/mall/dir_osh_/.d.ax/.sal.ax/osh_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_osh_/.d.ax/.sal.ax/osh_.body.sh"
        return 1
    fi
