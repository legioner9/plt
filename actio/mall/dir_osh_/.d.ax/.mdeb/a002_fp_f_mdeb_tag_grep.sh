#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_osh_/.d.ax/.mdeb/a002_fp_f_mdeb_tag_grep.sh"
...
a002_fp_f_mdeb_tag_grep() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_osh_/.d.ax/.mdeb/a002_fp_f_mdeb_tag_grep.sh)
