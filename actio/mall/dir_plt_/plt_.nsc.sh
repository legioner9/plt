...
filename="${PLT_PATH}/actio/mall/dir_plt_/plt_.sh"
...
# echo ". ${FN_SAL_DIR}/plt_.body.nsc.sh"
if ! . "${FN_SAL_DIR}/plt_.body.nsc.sh"; then
${_plt_exit} "fail: . ${FN_SAL_DIR}/plt_.body.sh"
return 1
fi
