...
filename="${PLT_PATH}/actio/mall/dir_dr2parr_/dr2parr_.nsc.sh"
...
dr2parr_() {
    ...
    #     ${_plt_exit} " dr2parr_ return 1: ${FNLOCK}"
    #     return 1
    # fi
    ...
    for var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_dr2parr_/.d.ax/.sal.ax/dr2parr_.local.list"); do
    ...
    if ! . "${PLT_PATH}/actio/mall/dir_dr2parr_/.d.ax/.sal.ax/dr2parr_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_dr2parr_/.d.ax/.sal.ax/dr2parr_.body.sh"
        return 1
    fi
