...
filename="${PLT_PATH}/actio/mall/dir_d3mm2exl_/d3mm2exl_.nsc.sh"
...
${_plt_exit} " d3mm2exl_ return 1: ${FNLOCK}"
return 1
fi
...
for local_var_fn in $(f2e "${PLT_PATH}/actio/mall/dir_d3mm2exl_/.d.ax/.sal.ax/d3mm2exl_.local.list"); do
...
# echo ". ${FN_SAL_DIR}/d3mm2exl_.body.nsc.sh"
if ! . "${PLT_PATH}/actio/mall/dir_d3mm2exl_/.d.ax/.sal.ax/d3mm2exl_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_d3mm2exl_/.d.ax/.sal.ax/d3mm2exl_.body.sh"
return 1
fi
