...
filename="${PLT_PATH}/actio/mall/dir_garg2e_v2_/garg2e_v2_.nsc.sh"
...
garg2e_v2_() {
    ...
    #     ${_plt_exit} " garg2e_v2_ return 1: ${FNLOCK}"
    #     return 1
    # fi
    ...
    for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_garg2e_v2_/.d.ax/.sal.ax/garg2e_v2_.local.list"); do
    ...
    if ! . "${PLT_PATH}/actio/mall/dir_garg2e_v2_/.d.ax/.sal.ax/garg2e_v2_.body.nsc.sh"; then
        ${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_garg2e_v2_/.d.ax/.sal.ax/garg2e_v2_.body.sh"
        return 1
    fi
