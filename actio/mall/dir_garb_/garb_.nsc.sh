...
filename="${PLT_PATH}/actio/mall/dir_garb_/garb_.nsc.sh"
...
${_plt_exit} " garb_ return 1: ${FNLOCK}"
return 1
fi
...
for var_fn in $("${_f2e}" "${PLT_PATH}/actio/mall/dir_garb_/.d.ax/.sal.ax/garb_.local.list"); do
...
if ! . "${PLT_PATH}/actio/mall/dir_garb_/.d.ax/.sal.ax/garb_.body.nsc.sh"; then
${_plt_exit} "fail: . ${PLT_PATH}/actio/mall/dir_garb_/.d.ax/.sal.ax/garb_.body.sh"
return 1
fi
