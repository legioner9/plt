#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/mall/dir_garb_/.d.ax/.mdeb/a003_fp_f_mdeb_with_0_0_0_arg.sh"
...
a003_fp_f_mdeb_with_0_0_0_arg() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/mall/dir_garb_/.d.ax/.mdeb/a003_fp_f_mdeb_with_0_0_0_arg.sh)
