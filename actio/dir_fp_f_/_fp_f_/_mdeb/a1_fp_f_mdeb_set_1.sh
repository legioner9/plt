#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/dir_fp_f_/_fp_f_/_mdeb/a1_fp_f_mdeb_set_1.sh"
...
a1_fp_f_mdeb_set_1() {
    ...
    local d_name=$(dirname ${PLT_PATH}/actio/dir_fp_f_/_fp_f_/_mdeb/a1_fp_f_mdeb_set_1.sh)
...
${NORMAL}"
    ...
    if [ "_head" == "$1" ]; then
        echo "a1_fp_f_mdeb_set_1 for test"
        return 0
    fi
    g_args=($(garg2e_ "${ARGS[@]}"))
