#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/dir_fp_f_/_fp_f_/_mdeb/.store/FNAA_1/dir_lll2_/_lll2_/_fn/lll2_mdeb_set_1.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_fp_f_/_fp_f_/_mdeb/.store/FNAA_1/dir_lll2_/_lll2_/_fn/lll2_mdeb_set_1.sh)
