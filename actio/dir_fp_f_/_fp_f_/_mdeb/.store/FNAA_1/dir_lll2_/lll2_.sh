...
filename="${PLT_PATH}/actio/dir_fp_f_/_fp_f_/_mdeb/.store/FNAA_1/dir_lll2_/lll2_.sh"
...
local FN_DIR=${PLT_PATH}/actio/dir_fp_f_/_fp_f_/_mdeb/.store/FNAA_1/dir_${FNN} #? contane dir of function
local FLN=$0
local ARGS=($@)
local NARGS=$#
local ARGS1=$1
...
#{see_cntl}
exit_err_lll2_() { #* $1 error message
local arg1="$1"
unset_autoargs_lll2_
...
# >${FN_OUT_DIR}/com_lll2_.res
# COMMAND &>>${FN_OUT_DIR}/com_lll2_.res
# if [ $? -ne 0 ]; then
#     if [ 1 -eq ${verbose} ]; then
#         cat ${FN_OUT_DIR}/com_lll2_.res
#     fi
#     #? runtime error allowed locally
#     error_allowed_locall_string="STRING"
#     if cat ${FN_OUT_DIR}/COMMAND_lll2_.res | is_rl_siev_and ${error_allowed_locall_string}; then
#         continue
#     else
#         exit_err_lll2_ "runtime error:: COMMAND ${addr}"
#     fi
# fi
#! amount args
