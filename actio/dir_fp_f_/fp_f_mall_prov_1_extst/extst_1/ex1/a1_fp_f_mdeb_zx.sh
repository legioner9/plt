#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/dir_fp_f_/fp_f_mall_prov_1_extst/extst_1/ex1/a1_fp_f_mdeb_zx.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_fp_f_/fp_f_mall_prov_1_extst/extst_1/ex1/a1_fp_f_mdeb_zx.sh)
