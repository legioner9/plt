...
filename="${PLT_PATH}/actio/dir_fp_f_/fp_f_mall_prov_1_extst/extst_1/ex1/_deb/res/dir_ex1_/ex1_.sh"
...
local FN_DIR=${PLT_PATH}/actio/dir_fp_f_/fp_f_mall_prov_1_extst/extst_1/ex1/_deb/res/dir_${FNN} #? contane dir of function
local FLN=$0
local ARGS=($@)
local NARGS=$#
local ARGS1=$1
...
# >${FN_OUT_DIR}/com_ex1_.res
# COMMAND &>>${FN_OUT_DIR}/com_ex1_.res
# if [ $? -ne 0 ]; then
#     if [ 1 -eq ${verbose} ]; then
#         cat ${FN_OUT_DIR}/com_ex1_.res
#     fi
#     #? runtime error allowed locally
#     error_allowed_locall_string="STRING"
#     if cat ${FN_OUT_DIR}/COMMAND_ex1_.res | is_rl_siev_and ${error_allowed_locall_string}; then
#         continue
#     else
#         exit_err_ex1_ "runtime error:: COMMAND ${addr}"
#     fi
# fi
#! amount args
