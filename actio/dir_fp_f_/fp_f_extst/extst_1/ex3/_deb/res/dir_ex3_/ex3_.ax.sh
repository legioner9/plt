...
filename="${PLT_PATH}/actio/dir_fp_f_/fp_f_extst/extst_1/ex3/_deb/res/dir_ex3_/ex3_.sh"
...
local FN_DIR=${PLT_PATH}/actio/dir_fp_f_/fp_f_extst/extst_1/ex3/_deb/res/dir_${FNN} #? contane dir of function
local FLN=$0
local ARGS=($@)
local NARGS=$#
local ARGS1=$1
...
# >${FN_OUT_DIR}/com_ex3_.res
# COMMAND &>>${FN_OUT_DIR}/com_ex3_.res
# if [ $? -ne 0 ]; then
#     if [ 1 -eq ${verbose} ]; then
#         cat ${FN_OUT_DIR}/com_ex3_.res
#     fi
#     #? runtime error allowed locally
#     error_allowed_locall_string="STRING"
#     if cat ${FN_OUT_DIR}/COMMAND_ex3_.res | is_rl_siev_and ${error_allowed_locall_string}; then
#         continue
#     else
#         exit_err_ex3_ "runtime error:: COMMAND ${addr}"
#     fi
# fi
#! amount args
