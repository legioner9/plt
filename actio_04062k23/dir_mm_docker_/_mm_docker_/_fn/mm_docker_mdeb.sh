#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/dir_mm_docker_/_mm_docker_/_fn/mm_docker_mdeb.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_mm_docker_/_mm_docker_/_fn/mm_docker_mdeb.sh)
