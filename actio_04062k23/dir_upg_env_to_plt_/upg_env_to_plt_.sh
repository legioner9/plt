...
filename="${PLT_PATH}/actio/dir_upg_env_to_plt_/upg_env_to_plt_.sh"
...
MAIN: exchage path : exec file upg_path_ (exa in communis dir)
NAME: ${FNN}()
...
${NORMAL}"
    ...
    local ptr_if_
    local ptr_sem_
    unset_autoargs_upg_env_to_plt_() {
        echo_=0
        debug_=0
        develop1_=0
        unset errmes_
    ...
    #{see_cntl}
    exit_err_upg_env_to_plt_() { #* $1 error message
        local arg1="$1"
        unset_autoargs_upg_env_to_plt_
    ...
    # >${FN_OUT_DIR}/com_upg_env_to_plt_.res
    # COMMAND &>>${FN_OUT_DIR}/com_upg_env_to_plt_.res
    # if [ $? -ne 0 ]; then
    #     if [ 1 -eq ${verbose} ]; then
    #         cat ${FN_OUT_DIR}/com_upg_env_to_plt_.res
    #     fi
    #     #? runtime error allowed locally
    #     error_allowed_locall_string="STRING"
    #     if cat ${FN_OUT_DIR}/COMMAND_upg_env_to_plt_.res | is_rl_siev_and ${error_allowed_locall_string}; then
    #         continue
    #     else
    #         exit_err_upg_env_to_plt_ "runtime error:: COMMAND ${addr}"
    #     fi
    # fi
    #! amount args
    ...
    # ------------------------------------------
    # -----------------------------------------------------------------------------------------
    # altlinux_upg_env_to_plt_() {
    #     :
    # }
    # fedora_upg_env_to_plt_() {
    #     :
    # }
