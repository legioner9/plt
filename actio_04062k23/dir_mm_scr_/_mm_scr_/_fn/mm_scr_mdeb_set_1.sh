#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/dir_mm_scr_/_mm_scr_/_fn/mm_scr_mdeb_set_1.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_mm_scr_/_mm_scr_/_fn/mm_scr_mdeb_set_1.sh)
