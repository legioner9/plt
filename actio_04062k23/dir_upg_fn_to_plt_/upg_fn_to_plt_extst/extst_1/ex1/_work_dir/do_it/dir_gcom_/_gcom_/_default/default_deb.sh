...
filename="${PATH_MAIN_REPO_FN_DIR}/dir_gcom_/_gcom_/_default/default_deb.sh"
...
gcom_ --tml "${PATH_VAR_DIR}/git/hsc_alt/main.var" --name "tgu" --autocommit "first_commit" -verbose
