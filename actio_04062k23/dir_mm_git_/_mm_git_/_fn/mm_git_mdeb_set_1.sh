#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/actio/dir_mm_git_/_mm_git_/_fn/mm_git_mdeb_set_1.sh"
...
local d_name=$(dirname ${PLT_PATH}/actio/dir_mm_git_/_mm_git_/_fn/mm_git_mdeb_set_1.sh)
