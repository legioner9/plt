...
${NORMAL}" #sistem info mesage
    ...
    if is_yes_654fe0b9ed "DO? : 3_git_init
    SSH_REMOVE_
    SSH_CREATE_
    ...
    if is_yes_654fe0b9ed "DO? : 4_git_clone
    clone plt.git
    clone communis.git
    clone fonsh.git
    ...
    if is_yes_654fe0b9ed "DO? : 5_first_copy_dotfiles" && [ -f "${PPWW_654fe0b9ed}"/.sh/5_first_copy_dotfiles.sh ]; then
        . "${PPWW_654fe0b9ed}"/.sh/5_first_copy_dotfiles.sh
    fi

    if is_yes_654fe0b9ed "DO? : 6_first_start_bash" && [ -f "${PPWW_654fe0b9ed}"/.sh/6_first_start_bash.sh ]; then
        . "${PPWW_654fe0b9ed}"/.sh/6_first_start_bash.sh
    fi

    if is_yes_654fe0b9ed "DO? : 7_post_first_" && [ -f "${PPWW_654fe0b9ed}"/.sh/7_post_first_.sh ]; then
