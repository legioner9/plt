...
switch ( $do ) {
	...
	case "offers" :
		include (DLEPlugins::Check(ENGINE_DIR . '/modules/offers.php'));
		break;
		
	case "mfo" :
		include (DLEPlugins::Check(ENGINE_DIR . '/modules/mfo.php'));
		break;
		
	case "banki" :
		include (DLEPlugins::Check(ENGINE_DIR . '/modules/banki.php'));
		break;
...
elseif ($do == 'offers'){ $nam_e = $module['speedbar']; $titl_e = $module['title']; }
elseif ($do == 'banki'){ $nam_e = $module['speedbar']; $titl_e = $module['title']; }
elseif ($do == 'mfo'){ $nam_e = $module['speedbar']; $titl_e = $module['title']; }
