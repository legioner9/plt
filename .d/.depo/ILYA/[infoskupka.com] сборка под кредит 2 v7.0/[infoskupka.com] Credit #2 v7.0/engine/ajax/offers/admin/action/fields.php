...
=====================================================
 Назначение: массовые действия с доп. полями
=====================================================
*/
...
HTML;
								...
								else
							{
								opentable();
								tableheader( "Список дополнительных полей &raquo; Массовые действия" );
								$SelectCategory = $Offers->SelectCategory( "", $CheckFields );
echo <<<HTML

<form method="post" action="" name="OffersMassAction" onsubmit="formSubmit( 'OffersMassAction', 'action.php', 'fields', 'ajax.gif', 'UpdateStatus', 'UpdateStatus', UpdateButton ); return false;">
	<div style="padding: 25px; text-align: center;">
