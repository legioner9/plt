								...
								foreach( $CheckBlocks as $id )
									{
										...
										if( $id )
											{
												//$Offers->SaveOffersOpt( $Offers->DB['offers_type'][2], array( "qwe" => "123" ) );
...
<form method="post" action="" name="OffersMassAction" onsubmit="formSubmit( 'OffersMassAction', 'action.php', 'blocks', 'ajax.gif', 'UpdateStatus', 'UpdateStatus', UpdateButton ); return false;">
	<div style="padding: 25px; text-align: center;">
