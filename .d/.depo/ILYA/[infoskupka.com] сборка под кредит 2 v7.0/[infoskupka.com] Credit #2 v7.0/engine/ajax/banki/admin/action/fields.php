...
HTML;
								...
								else
							{
								opentable();
								tableheader( "Список дополнительных полей &raquo; Массовые действия" );
								$SelectCategory = $Banki->SelectCategory( "", $CheckFields );
echo <<<HTML

<form method="post" action="" name="BankiMassAction" onsubmit="formSubmit( 'BankiMassAction', 'action.php', 'fields', 'ajax.gif', 'UpdateStatus', 'UpdateStatus', UpdateButton ); return false;">
	<div style="padding: 25px; text-align: center;">
