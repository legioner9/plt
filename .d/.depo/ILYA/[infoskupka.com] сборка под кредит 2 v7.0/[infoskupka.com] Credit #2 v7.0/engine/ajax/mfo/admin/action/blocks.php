								...
								foreach( $CheckBlocks as $id )
									{
										...
										if( $id )
											{
												//$Mfo->SaveMfoOpt( $Mfo->DB['mfo_type'][2], array( "qwe" => "123" ) );
...
<form method="post" action="" name="MfoMassAction" onsubmit="formSubmit( 'MfoMassAction', 'action.php', 'blocks', 'ajax.gif', 'UpdateStatus', 'UpdateStatus', UpdateButton ); return false;">
	<div style="padding: 25px; text-align: center;">
