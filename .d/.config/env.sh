...
PATH_FRC_DIR="${PLT_PATH}"/.d/.frc

PATH_CURR_REPO="${HOME}/REPOBARE/_repo"

#? MOIN

PATH_MONI__ISSUE_DIR="${HOME}/REPOBARE/_repo/NPython/Pala/py_wiki/MoinMoin/"
PATH_MONI_APP_DIR="${HOME}/MoniMoniApp"
VERSION_MOIN_APP="1.9.11"
VERSION_PYTHON_FOR_MOIN_APP="2.7"
...
ARR_L_RU=('й' 'ц' 'у' 'к' 'е' 'н' 'г' 'ш' 'щ' 'з' 'х' 'ъ' 'ф' 'ы' 'в' 'а' 'п' 'р' 'о' 'л' 'д' 'ж' 'э' 'я' 'ч' 'с' 'м' 'и' 'т' 'ь' 'б' 'ю')
ARR_U_RU=('Й' 'Ц' 'У' 'К' 'Е' 'Н' 'Г' 'Ш' 'Щ' 'З' 'Х' 'Ъ' 'Ф' 'Ы' 'В' 'А' 'П' 'Р' 'О' 'Л' 'Д' 'Ж' 'Э' 'Я' 'Ч' 'С' 'М' 'И' 'Т' 'Ь' 'Б' 'Ю')
ARR_A_RU=('й' 'ц' 'у' 'к' 'е' 'н' 'г' 'ш' 'щ' 'з' 'х' 'ъ' 'ф' 'ы' 'в' 'а' 'п' 'р' 'о' 'л' 'д' 'ж' 'э' 'я' 'ч' 'с' 'м' 'и' 'т' 'ь' 'б' 'ю' 'Й' 'Ц' 'У' 'К' 'Е' 'Н' 'Г' 'Ш' 'Щ' 'З' 'Х' 'Ъ' 'Ф' 'Ы' 'В' 'А' 'П' 'Р' 'О' 'Л' 'Д' 'Ж' 'Э' 'Я' 'Ч' 'С' 'М' 'И' 'Т' 'Ь' 'Б' 'Ю')