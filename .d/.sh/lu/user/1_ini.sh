...
f2a() {
    echo -e "${CYAN}---f2a() $.1=$1---${NORMAL}" #started functions
...
s2a() {
    echo -e "${CYAN}---s2a() $.1=$1 $.2=$2---${NORMAL}" #started functions
...
f2a_all() { # $1=$HOME/.gitrepo
    ...
    echo -e "${CYAN}---f2a_all() $.1=$1---${NORMAL}" #started functions
