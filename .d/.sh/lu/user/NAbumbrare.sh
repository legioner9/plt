#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PATH_COMMUNIS}/Deploy_store/.qa/lib/user/NAbumbrare.sh"
...
NAbumbrare() {
    ...
    local d_name=$(dirname ${PATH_COMMUNIS}/Deploy_store/.qa/lib/user/NAbumbrare.sh)
...
${NORMAL}"
    ...
    # amount_arg $# 1 1
    #{body_fn}
    edit_ "${PATH_CURR_REPO}/NAbumbrare"
}
