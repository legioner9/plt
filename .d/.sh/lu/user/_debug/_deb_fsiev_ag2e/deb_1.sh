...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/lib/user/_debug/_deb_fsiev_ag2e/deb_1.sh"
...
#-------------------------------
rr_
fsiev_ag2e "cat ${COMMUNIS_PATH}/Deploy_store/.qa/lib/user/_debug/_deb_fsiev_ag2e/deb_1.sh" "#"
