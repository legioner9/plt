...
filename="${COMMUNIS_PATH}/Deploy_store/.qa/lib/user/site2d_5.sh"
...
site2d_5() { #$1 string $2 delimer $3 num of sequence
    # echo -e "${CYAN}--- ${FUNCNAME[0]}() $* ---${NORMAL}" #started functions

    # echo -e "${CYAN}--- ${FUNCNAME[0]}() $* ---${NORMAL}" #started functions
    local FNN=${FUNCNAME[0]}
    local PPW=$(prs_f -d "${COMMUNIS_PATH}/Deploy_store/.qa/lib/user/site2d_5.sh") # FILENAME==="filename"
    path_ext=$PPW/$FNN
    ...
    plt_pause "do? : wget -r -l5 -k -p -E -nc ${ar1} ${ar2}"
