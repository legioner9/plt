#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/red_stderr__.ram/.grot/red_stderr__.sh"
...
red_stderr__()(set -o pipefail;"$@" 2> >(sed $'s,.*,\e[31m&\e[m,'>&2))
export -f red_stderr__
#  {
...
#     local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/red_stderr__.ram/.grot/red_stderr__.sh)
