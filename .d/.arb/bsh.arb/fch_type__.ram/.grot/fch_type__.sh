#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/fch_type__.ram/.grot/fch_type__.sh"
...
fch_type__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/fch_type__.ram/.grot/fch_type__.sh)
...
EXAMP: 
    ...
    p : named pipe
    s : socket
    D : door (PC in a client server scenario)
