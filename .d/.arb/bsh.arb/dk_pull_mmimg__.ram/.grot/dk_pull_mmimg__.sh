#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/dk_pull_mmimg__.ram/.grot/dk_pull_mmimg__.sh"
...
dk_pull_mmimg__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/dk_pull_mmimg__.ram/.grot/dk_pull_mmimg__.sh)
...
${RED}---${NORMAL}"
    ...
    parr2mm_ arr_file_name arr_file_result result
...
${RED}---${NORMAL}"
    ...
    parr2mm_ arr_img_name arr_img_name result
