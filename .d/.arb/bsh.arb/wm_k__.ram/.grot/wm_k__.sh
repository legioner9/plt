#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/wm_k__.ram/.grot/wm_k__.sh"
...
wm_k__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/wm_k__.ram/.grot/wm_k__.sh)
...
${NORMAL}"
    ...
    echo -e "${HLIGHT}--- VBoxManage controlvm $1 acpipowerbutton ---${NORMAL}" #start files
    eval VBoxManage controlvm "$1" acpipowerbutton
}
