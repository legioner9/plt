#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/dk_ls_runi_cont__.ram/.grot/dk_ls_runi_cont__.sh"
...
dk_ls_runi_cont__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/dk_ls_runi_cont__.ram/.grot/dk_ls_runi_cont__.sh)
