#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/dk_al_im__.ram/.grot/dk_al_im__.sh"
...
dk_al_im__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/dk_al_im__.ram/.grot/dk_al_im__.sh)
...
${NORMAL}"
    ...
    #{default_cntl_fn}
    # amount_arg $# 1 1
    echo -e "${HLIGHT}--- exec: docker images ---${NORMAL}" #start files
    docker images
