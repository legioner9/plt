#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/rnd2d__.ram/.grot/rnd2d__.sh"
...
rnd2d__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/rnd2d__.ram/.grot/rnd2d__.sh)
    # wrp_fifs1_ cd ${d_name} -d
    #{intro_fn}
    if [ "-h" == "$1" ]; then
        echo -e "${CYAN} ${FNN}() help: 
MAIN: echo random 0-32767 (16 bite)
NAME: ${FNN}()
