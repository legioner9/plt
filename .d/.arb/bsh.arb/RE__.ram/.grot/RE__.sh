#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/RE__.ram/.grot/RE__.sh"
...
RE__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/RE__.ram/.grot/RE__.sh)
...
${NORMAL}"
    ...
    edit_ ${PLT_PATH}/.d/.md.ax/README.md
    edit_ ${PLT_PATH}/README.md
