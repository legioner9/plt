#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/tm_km__.ram/.grot/tm_km__.sh"
...
tm_km__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/tm_km__.ram/.grot/tm_km__.sh)
...
${NORMAL}"
    ...
    IFS=$'\n'
    PS3="select timux session to kill:"
