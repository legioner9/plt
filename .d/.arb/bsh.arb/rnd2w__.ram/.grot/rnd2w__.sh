#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/rnd2w__.ram/.grot/rnd2w__.sh"
...
rnd2w__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/rnd2w__.ram/.grot/rnd2w__.sh)
