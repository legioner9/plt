#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/dpl_after_pull__.ram/.grot/dpl_after_pull__.sh"
...
dpl_after_pull__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/dpl_after_pull__.ram/.grot/dpl_after_pull__.sh)
