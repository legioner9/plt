#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/dd2e__.ram/.grot/dd2e__.sh"
...
dd2e__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/dd2e__.ram/.grot/dd2e__.sh)
...
${NORMAL}"
    ...
    if ! [ -d "$1" ]; then
        plt_info "in dd2e__() : first arg NOT_DIR : '$1' : return 1"
        return 1
    fi
