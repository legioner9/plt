#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/dk_pullm__.ram/.grot/dk_pullm__.sh"
...
dk_pullm__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/dk_pullm__.ram/.grot/dk_pullm__.sh)
...
${NORMAL}"
    ...
    dir_file_lst=${PLT_PATH}/lex/.d/.lst/dk_pullm__
