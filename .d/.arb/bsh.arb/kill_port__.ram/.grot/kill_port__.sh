#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/bsh.arb/kill_port__.ram/.grot/kill_port__.sh"
...
kill_port__() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/bsh.arb/kill_port__.ram/.grot/kill_port__.sh)
...
${NORMAL}"
    ...
    if isn_from__ ${NARGS} 1 1 "in ${FNN}() : ERR_AMOUNT_ARGS : return 1"; then
        return 1
    fi

    echo "port:$1 :: kill -9 $(lsof -t -i:"$1")"
