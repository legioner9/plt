#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/osh.arb/remove_rbenv___.ram/.grot/remove_rbenv___.sh"
...
remove_rbenv___() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/osh.arb/remove_rbenv___.ram/.grot/remove_rbenv___.sh)
