#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/osh.arb/man1_to_arb___.ram/.grot/man1_to_arb___.sh"
...
man1_to_arb___() {
    ...
    local d_name=$(dirname ${PLT_PATH}/.d/.arb/osh.arb/man1_to_arb___.ram/.grot/man1_to_arb___.sh)
