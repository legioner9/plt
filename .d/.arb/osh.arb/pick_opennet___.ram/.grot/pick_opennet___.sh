#!/bin/bash
#. "${HOME}/.bashrc"
filename="${PLT_PATH}/.d/.arb/osh.arb/pick_opennet___.ram/.grot/pick_opennet___.sh"
...
local d_name=$(dirname ${PLT_PATH}/.d/.arb/osh.arb/pick_opennet___.ram/.grot/pick_opennet___.sh)
