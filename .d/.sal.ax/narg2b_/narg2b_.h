...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_narg2b_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_narg2b_/_gnr_dir_sys.sh create extst in dir_narg2b_
- . ${PLT_PATH}/actio/mall/dir_narg2b_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$narg2b__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_narg2b_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_narg2b__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: narg2b_ narg2b_c_ narg2b_g_
{rtfn}
.
EXAM:
{exam}
