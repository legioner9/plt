...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_cr_infn_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_cr_infn_/_gnr_dir_sys.sh create extst in dir_cr_infn_
- . ${PLT_PATH}/actio/mall/dir_cr_infn_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$cr_infn__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_cr_infn_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_cr_infn__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: cr_infn_ cr_infn_c_ cr_infn_g_
{rtfn}
.
EXAM:
