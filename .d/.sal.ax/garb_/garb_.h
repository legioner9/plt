...
.
ARGS:
$1 (cntl (-n -an -t -at -t -m -c) [, $2 mach_to_grep]) or ram_name
CNTLS:
--_arb_path path to arb for grep
-_
LOGIC ARGS:
!()
?()
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_garb_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_garb_/_gnr_dir_sys.sh create extst in dir_garb_
- . ${PLT_PATH}/actio/mall/dir_garb_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$garb__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_garb_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_garb__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: garb_ garb_c_ garb_g_
{rtfn}
.
EXAM:
