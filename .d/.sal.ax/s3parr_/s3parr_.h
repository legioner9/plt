...
{name}
.
MAIN: delim str_ at del_ -> modify parr_
{main}
.
ARGS:
CNTL:
--_str string for delim
--_del delimeter
--_parr ptr to global arr for modify
{args}
.
RETU: 
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_s3parr_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_s3parr_/_gnr_dir_sys.sh create extst in dir_s3parr_
- . ${PLT_PATH}/actio/mall/dir_s3parr_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$s3parr__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_s3parr_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_s3parr__mdeb <num>
{lego}
.
LNGF:
{lngf}
