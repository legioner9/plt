...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_f2scr_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_f2scr_/_gnr_dir_sys.sh create extst in dir_f2scr_
- . ${PLT_PATH}/actio/mall/dir_f2scr_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$f2scr__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_f2scr_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_f2scr__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: f2scr_ f2scr_c_ f2scr_g_
{rtfn}
.
EXAM:
.
( e b) before after (?<=\ \ e\ b).*(?=\ \ e\ b) , 
перенос ()[\w\W]*(),нежад ().*?(),
нежад+перенос ()[\w\W]*?()
.
pstr_b="aefd"
pstr_a="luyiol"
pstr_body='[\w\W]*?' # other rgs: '.+?' '[\w\W]*' '.*?'
file_1="upath/to/file_for_matching"
f2scr_ --_file ${file_1} --_pstr_before pstr_b --_pstr_after pstr_a -_pstr_body pstr_body
{exam}
.
MANF:
{manf}
