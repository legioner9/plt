...
{name}
.
MAIN: zip with pass from-to file
{main}
.
ARGS:
$1 prl
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_pzip_to_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_pzip_to_/_gnr_dir_sys.sh create extst in dir_pzip_to_
- . ${PLT_PATH}/actio/mall/dir_pzip_to_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$pzip_to__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_pzip_to_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_pzip_to__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: pzip_to_ pzip_to_c_ pzip_to_g_
{rtfn}
.
EXAM:
pzip_to_ 0 file_dist.zip dir_src 1 
pzip_to_ 321 file_dist dir_src 0
{exam}
.
MANF:
{manf}
