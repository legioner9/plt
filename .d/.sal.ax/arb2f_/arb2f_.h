...
{name}
.
MAIN: insert arb to file (file.tml => ${tml} => {tml})
{main}
.
ARGS:
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_arb2f_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_arb2f_/_gnr_dir_sys.sh create extst in dir_arb2f_
- . ${PLT_PATH}/actio/mall/dir_arb2f_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$arb2f__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_arb2f_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_arb2f__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: arb2f_ arb2f_c_ arb2f_g_
{rtfn}
.
EXAM:
{exam}
