...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_parr3e_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_parr3e_/_gnr_dir_sys.sh create extst in dir_parr3e_
- . ${PLT_PATH}/actio/mall/dir_parr3e_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$parr3e__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_parr3e_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_parr3e__mdeb <num>
{lego}
.
LNGF:
{lngf}
