...
{name}
.
MAIN: cr arb fol_ --_sil ${SIL_A} -_crarb --_arb $1
{main}
.
ARGS:
$1 arb_dir to cr
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_cr_arb_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_cr_arb_/_gnr_dir_sys.sh create extst in dir_cr_arb_
- . ${PLT_PATH}/actio/mall/dir_cr_arb_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$cr_arb__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_cr_arb_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_cr_arb__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: cr_arb_ cr_arb_c_ cr_arb_g_
{rtfn}
.
EXAM:
{exam}
