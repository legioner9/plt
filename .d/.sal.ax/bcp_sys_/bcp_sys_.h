...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_bcp_sys_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_bcp_sys_/_gnr_dir_sys.sh create extst in dir_bcp_sys_
- . ${PLT_PATH}/actio/mall/dir_bcp_sys_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$bcp_sys__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_bcp_sys_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_bcp_sys__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: bcp_sys_ bcp_sys_c_ bcp_sys_g_
{rtfn}
.
EXAM:
{exam}
