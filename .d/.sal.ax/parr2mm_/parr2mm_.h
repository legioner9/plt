...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_parr2mm_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_parr2mm_/_gnr_dir_sys.sh create extst in dir_parr2mm_
- . ${PLT_PATH}/actio/mall/dir_parr2mm_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$parr2mm__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_parr2mm_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_parr2mm__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: parr2mm_ parr2mm_c_ parr2mm_g_
{rtfn}
.
EXAM:
local a1=(1 2)
