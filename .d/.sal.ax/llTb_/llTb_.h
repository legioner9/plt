...
{name}
.
MAIN: [l]ist extends, [l]ist dirs [T]ST to [b]ool
{main}
.
ARGS:
$1 
CNTLS:
--_lst_ext file.lst with extends
--_lst_dir file.lst with dir for exec tst file.ext
{args}
.
RETU: 
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_llTb_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_llTb_/_gnr_dir_sys.sh create extst in dir_llTb_
- . ${PLT_PATH}/actio/mall/dir_llTb_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$llTb__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_llTb_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_llTb__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: llTb_ llTb_c_ llTb_g_
{rtfn}
.
EXAM:
{exam}
