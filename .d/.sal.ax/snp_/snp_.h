...
{name}
.
MAIN: add snippet to --_file from --_dir
{main}
.
ARGS:
$1 
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_snp_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_snp_/_gnr_dir_sys.sh create extst in dir_snp_
- . ${PLT_PATH}/actio/mall/dir_snp_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$snp__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_snp_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_snp__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: snp_ snp_c_ snp_g_
{rtfn}
.
EXAM:
{exam}
