...
{name}
.
MAIN: menu do save to git local and net repo 
{main}
.
ARGS:
$1 
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_nm_opi_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_nm_opi_/_gnr_dir_sys.sh create extst in dir_nm_opi_
- . ${PLT_PATH}/actio/mall/dir_nm_opi_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$nm_opi__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_nm_opi_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_nm_opi__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: nm_opi_ nm_opi_c_ nm_opi_g_
{rtfn}
.
EXAM:
{exam}
