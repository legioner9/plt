...
{name}
.
MAIN: mm: choice node that insert instead root dir
{main}
.
ARGS:
$1 
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_ins_nod_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_ins_nod_/_gnr_dir_sys.sh create extst in dir_ins_nod_
- . ${PLT_PATH}/actio/mall/dir_ins_nod_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$ins_nod__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_ins_nod_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_ins_nod__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: ins_nod_ ins_nod_c_ ins_nod_g_
{rtfn}
.
EXAM:
{exam}
