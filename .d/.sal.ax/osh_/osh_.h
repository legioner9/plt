...
{name}
.
MAIN: osh_ <name_fn> - exec : <name_fn> after up to mem : . ${PLT_PATH}/.d/.arb/osh.arb/<name_fn>.ram/.grot/<name_fn>.sh
{main}
.
ARGS:
$1 once name_fn
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_osh_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_osh_/_gnr_dir_sys.sh create extst in dir_osh_
- . ${PLT_PATH}/actio/mall/dir_osh_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$osh__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_osh_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_osh__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: osh_ osh_c_ osh_g_
{rtfn}
.
EXAM:
{exam}
