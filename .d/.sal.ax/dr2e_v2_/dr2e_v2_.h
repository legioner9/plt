...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_dr2e_v2_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_dr2e_v2_/_gnr_dir_sys.sh create extst in dir_dr2e_v2_
- . ${PLT_PATH}/actio/mall/dir_dr2e_v2_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$dr2e_v2__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_dr2e_v2_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_dr2e_v2__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: dr2e_v2_ dr2e_v2_c_ dr2e_v2_g_
{rtfn}
.
EXAM:
{exam}
