...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_mm_execf_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_mm_execf_/_gnr_dir_sys.sh create extst in dir_mm_execf_
- . ${PLT_PATH}/actio/mall/dir_mm_execf_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$mm_execf__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_mm_execf_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_mm_execf__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: mm_execf_ mm_execf_c_ mm_execf_g_
{rtfn}
.
EXAM:
{exam}
