...
{name}
.
MAIN: files from dir recurce => parr+=
{main}
.
ARGS:
!$1 parr
...
LEGO:
- . ${PLT_PATH}/actio/mall/dir_dr2parr_/.d/.dd/cr_tree_gign_dir.sh - create tree_gign_dir.man with tree
- . ${PLT_PATH}/actio/mall/dir_dr2parr_/_gnr_dir_sys.sh create extst in dir_dr2parr_
- . ${PLT_PATH}/actio/mall/dir_dr2parr_/.d/.mdeb/.cntl/_start_ex1_mdeb.sh start dir_$dr2parr__mdeb <num>
- . ${PLT_PATH}/actio/mall/dir_dr2parr_/.d/.mdeb/.cntl/_cr_ex1_mdeb_postfix.sh create point file fo function dir_dr2parr__mdeb <num>
{lego}
.
LNGF:
{lngf}
.
RTFN: dr2parr_ dr2parr_c_ dr2parr_g_
{rtfn}
.
EXAM:
{exam}
