...
01_enter_cond_proc_fol__01_glob_phylum_a_sil() {
    ...
    echo -e "${CYAN}--- 01_enter_cond_proc_fol__01_glob_phylum_a_sil() file://${PLT_PATH}/.d/.sil.ax/phylum_a.sil/proc/fol_/01_glob/01_enter_cond_proc_fol__01_glob_phylum_a_sil.sh ---${NORMAL}" #sistem info mesage
