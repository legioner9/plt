...
${_wrp2_} cp -rf --_xxf "${tml_dir}/file.puml" --_xnf "$PWD/dir_${name_fn_}/${name_fn_}.puml"

${_wrp2_} cp -rf --_xxd "${tml_dir}/_00000" --_xnd "$PWD/dir_${name_fn_}/_${name_fn_}"

${_wrp2_} cp -rf --_xxd "${tml_dir}/.fn_env" --_xnd "$PWD/dir_${name_fn_}/.fn_env"
